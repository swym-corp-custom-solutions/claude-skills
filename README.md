...
```
[skill-updater] updated swym-shopify-thememate-theme-editor 4.0.0 -> 5.0.0
```
...
Every time the auto-updater applies an update, it archives the previous version locally at:
```
...
cp ~/.claude/skills/swym-shopify-thememate-theme-editor/versions/SKILL-4.0.0.md \
   ~/.claude/skills/swym-shopify-thememate-theme-editor/SKILL.md
```
